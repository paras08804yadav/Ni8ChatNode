...
//         agency.waitedHost.push({
//             host_id: host_id,
         
//         });
//         await agency.save(); // Save the updated agency document

//         // Step 6: Update the host's requestStatus (Make sure requestStatus exists in your Host schema)
//         host.requestStatus = "waiting"; // Update requestStatus to 'waiting'
//         await host.save();// Save the updated host document
